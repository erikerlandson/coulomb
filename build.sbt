...
def commonSettings = Seq(
  ...
  //---------------------------------
  addCompilerPlugin("org.typelevel" % "kind-projector_2.13.3" % "0.11.3"),
  resolvers ++= Seq(
...
def coulombCatsDeps = Def.setting(Seq(
  "org.typelevel" %%% "cats-core" % "2.4.0" % Provided,
  "org.typelevel" %%% "cats-testkit" % "2.4.0" % Provided,
...
def coulombRefinedDeps = Def.setting(Seq(
  "eu.timepit" %%% "refined" % "0.9.20" % Provided)
)
