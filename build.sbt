...
def coulombAvroDeps = Seq(
  "org.apache.avro" % "avro" % "1.10.2" % Provided
)
...
def coulombPureConfigDeps = Seq(
  "com.github.pureconfig" %% "pureconfig-core" % "0.17.0" % Provided,
  "com.github.pureconfig" %% "pureconfig-generic" % "0.17.0" % Provided,
)

def coulombCatsDeps = Def.setting(Seq(
  "org.typelevel" %%% "cats-core" % "2.6.1" % Provided,
  "org.typelevel" %%% "cats-testkit" % "2.6.1" % Provided,
