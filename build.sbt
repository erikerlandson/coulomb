...
def commonSettings = Seq(
  ...
  //---------------------------------
  addCompilerPlugin("org.typelevel" % "kind-projector_2.13.3" % "0.13.3"),
  resolvers ++= Seq(
...
def coulombPureConfigDeps = Seq(
  "com.github.pureconfig" %% "pureconfig-core" % "0.17.5" % Provided,
  "com.github.pureconfig" %% "pureconfig-generic" % "0.17.5" % Provided,
)
...
def coulombRefinedDeps = Def.setting(Seq(
  "eu.timepit" %%% "refined" % "0.11.1" % Provided)
)
