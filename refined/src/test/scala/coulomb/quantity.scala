...
class RefinedQuantityAlgebraicSuite extends CoulombSuite:
    ...
    test("lift") {
        ...
        1f.withRP[Positive]
            .withUnit[Meter]
            .assertQ[Refined[Float, Positive], Meter](1f.withRP[Positive])
        1L.withRP[Positive]
            .withUnit[Meter]
            .assertQ[Refined[Long, Positive], Meter](1L.withRP[Positive])
        1.withRP[Positive]
            .withUnit[Meter]
        ...
        1d.withRP[NonNegative]
            .withUnit[Meter]
            .assertQ[Refined[Double, NonNegative], Meter](
                1d.withRP[NonNegative]
            )
        ...
        1L.withRP[NonNegative]
            .withUnit[Meter]
            .assertQ[Refined[Long, NonNegative], Meter](1L.withRP[NonNegative])
    ...
    test("value") {
        1.withRP[Positive]
            .withUnit[Meter]
            .value
            .assertVT[Refined[Int, Positive]](1.withRP[Positive])

        refineVU[Positive, Meter](1).value
            .assertVT[RefinedE[Int, Positive]](refineV[Positive](1))
    }
    ...
    test("showFull") {
        assertEquals(
            1.withRP[NonNegative].withUnit[Second].showFull,
            "1 second"
        )
    ...
    test("toValue") {
        ...
        refineVU[Positive, Meter](1)
            ...
            .assertQ[RefinedE[Double, Positive], Meter](refineV[Positive](1d))
        assert(
            refineVU[Positive, Meter](Double.MinPositiveValue)
                .toValue[RefinedE[Float, Positive]]
                .value
                .isLeft
        )
    }
    ...
    test("toUnit") {
        ...
        refineVU[Positive, Kilo * Meter](1d)
            .toUnit[Meter]
            .assertQ[RefinedE[Double, Positive], Meter](
                refineV[Positive](1000d)
            )
        assert(
            refineVU[Positive, Meter](Double.MinPositiveValue)
                .toUnit[Kilo * Meter]
    ...
    test("add strict") {
        ...
        (1.withRP[Positive]
            .withUnit[Meter] + 2.withRP[Positive].withUnit[Meter])
        ...
        (1L.withRP[NonNegative]
            .withUnit[Meter] + 2L.withRP[NonNegative].withUnit[Meter])
        ...
        assertCE(
            "1.withRP[Positive].withUnit[Meter] + 2d.withRP[Positive].withUnit[Meter]"
        )
        assertCE(
        ...
        (x + x).assertQ[RefinedE[Double, Positive], Meter](
            refineV[Positive](2d)
        )
    ...
    test("multiply strict") {
        ...
        (2.withRP[NonNegative]
            .withUnit[Meter] * 3.withRP[NonNegative].withUnit[Meter])
            .assertQ[Refined[Int, NonNegative], Meter ^ 2](
                6.withRP[NonNegative]
            )
        ...
        assertCE(
            "2d.withRP[NonNegative].withUnit[Meter] * 3d.withRP[Positive].withUnit[Meter]"
        )

        val x = refineVU[Positive, Meter](2d)
        val z = refineVU[Positive, Meter](0d)
        (x * x).assertQ[RefinedE[Double, Positive], Meter ^ 2](
            refineV[Positive](4d)
        )
        assert((x * z).value.isLeft)
        assert((z * x).value.isLeft)
    ...
    test("multiply standard") {
        ...
        (2L.withRP[NonNegative]
            .withUnit[Meter] * 3L.withRP[NonNegative].withUnit[Meter])
            .assertQ[Refined[Long, NonNegative], Meter ^ 2](
    ...
    test("divide strict") {
        ...
        assertCE(
            "12d.withRP[Positive].withUnit[Meter] / 3f.withRP[Positive].withUnit[Second]"
        )
        // NonNegative is not multiplicative group
        assertCE(
            "12d.withRP[NonNegative].withUnit[Meter] / 3d.withRP[NonNegative].withUnit[Second]"
        )
    ...
    test("power") {
        ...
        x.pow[2]
            .assertQ[RefinedE[Double, Positive], Meter ^ 2](
                refineV[Positive](4d)
            )
