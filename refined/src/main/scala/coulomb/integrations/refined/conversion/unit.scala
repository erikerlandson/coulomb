...
package coulomb.integrations.refined.conversion
...
object unit:
    given g_UC_Refined_Positive[V, UF, UT](using
    ...
    given g_UC_Refined_NonNegative[V, UF, UT](using
        uc: UnitConversion[V, UF, UT],
    ...
    given g_DUC_Refined_Positive[V, B, UF, UT](using
        uc: DeltaUnitConversion[V, B, UF, UT],
        vld: Validate[V, Positive]
    ): DeltaUnitConversion[Refined[V, Positive], B, UF, UT] =
        (v: Refined[V, Positive]) => refineV[Positive].unsafeFrom(uc(v.value))

    given g_DUC_Refined_NonNegative[V, B, UF, UT](using
        uc: DeltaUnitConversion[V, B, UF, UT],
        vld: Validate[V, NonNegative]
    ...
    given g_UC_Refined_Either[V, P, UF, UT](using
    ...
    given g_DUC_Refined_Either[V, B, P, UF, UT](using
