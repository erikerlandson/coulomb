...
class TimeTests extends munit.FunSuite {
  test("EpochTime") {
  ...
  test("integrate Instant with coulomb") {
    ...
    assertEquals(Instant.parse("1969-07-20T00:00:00Z").plus(1D.withUnit[Week]).toString, "1969-07-27T00:00:00Z")
    assertEquals(Instant.parse("1969-07-20T00:00:00Z").minus(1D.withUnit[Week]).toString, "1969-07-13T00:00:00Z")
  }
