...
class RefinedTests extends munit.FunSuite {
  test("toRefined") {
  ...
  test("refined addition") {
    ...
    assert(compileErrors("1D.withRefinedUnit[Positive, Meter] + 1f.withUnit[Foot]").nonEmpty)
    assert(compileErrors("1D.withRefinedUnit[Positive, Foot] + 1f.withRefinedUnit[Greater[-10f], Meter]").nonEmpty)
    assert(compileErrors("(-1D).withRefinedUnit[Negative, Foot] + (-1f).withRefinedUnit[Less[10f], Meter]").nonEmpty)
  ...
  test("refined subtraction") {
    ...
    // unsound compile errors by default
    assert(compileErrors("1D.withRefinedUnit[Positive, Meter] - 1f.withUnit[Foot]").nonEmpty)
    assert(compileErrors("1D.withRefinedUnit[Positive, Foot] - (-1f).withRefinedUnit[Less[10f], Meter]").nonEmpty)
    assert(compileErrors("(-1D).withRefinedUnit[Negative, Foot] - (1f).withRefinedUnit[Greater[-10f], Meter]").nonEmpty)
  ...
  test("refined multiplication") {
    ...
    assert(compileErrors("2D.withRefinedUnit[Positive, Meter] * 2D.withRefinedUnit[GreaterEqual[0D], Meter]").nonEmpty)
    assert(compileErrors("2D.withRefinedUnit[Greater[1D], Meter] * 2D.withRefinedUnit[Positive, Meter]").nonEmpty)
    assert(compileErrors("2D.withRefinedUnit[Positive, Meter] * 2D.withUnit[Meter]").nonEmpty)
  ...
  test("refined division") {
    ...
    assert(compileErrors("(1D).withRefinedUnit[Positive, Meter] / 2D.withUnit[Second]").nonEmpty)
    assert(compileErrors("(1D).withRefinedUnit[NonNegative, Meter] / (2D).withRefinedUnit[Greater[-1D], Second]").nonEmpty)
    assert(compileErrors("(-1D).withRefinedUnit[Negative, Meter] / (2D).withRefinedUnit[Not[Less[-1D]], Second]").nonEmpty)
  ...
  test("refined power") {
    ...
    assert(compileErrors("2f.withRefinedUnit[NonNegative, Second].pow[-3]").nonEmpty)
    assert(compileErrors("2f.withRefinedUnit[Greater[-1f], Second].pow[3]").nonEmpty)
  ...
  test("refined conversion") {
    ...
    assert(compileErrors("(1D).withRefinedUnit[NonNegative, Meter].toValue[Refined[Float, Positive]]").nonEmpty)
    assert(compileErrors("(1D).withUnit[Meter].toValue[Refined[Float, Positive]]").nonEmpty)
    assert(compileErrors("(1D).withRefinedUnit[Greater[-1D], Meter].to[Refined[Float, NonNegative], Foot]").nonEmpty)
