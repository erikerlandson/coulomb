...
object implicitConversion:
    ...
    given ctx_implicit_quantity_conversion_1V1U[V, U](using
        aic: AllowImplicitConversions
            ): scala.Conversion[Quantity[V, U], Quantity[V, U]] =
        new scala.Conversion[Quantity[V, U], Quantity[V, U]]:
    ...
    given ctx_implicit_quantity_conversion_1V2U[V, UF, UT](using
        ...
        uc: UnitConversion[V, UF, UT]
            ): scala.Conversion[Quantity[V, UF], Quantity[V, UT]] =
        new scala.Conversion[Quantity[V, UF], Quantity[V, UT]]:
    ...
    given ctx_implicit_quantity_conversion_2V1U[U, VF, VT](using
        ...
        vc: ValueConversion[VF, VT],
            ): scala.Conversion[Quantity[VF, U], Quantity[VT, U]] =
        new scala.Conversion[Quantity[VF, U], Quantity[VT, U]]:
