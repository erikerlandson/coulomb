...
class QuantitySuite extends CoulombSuite:
    ...
    test("addition strict") {
        ...
        (1d.withUnit[Meter] + 1d.withUnit[Yard].toUnit[Meter])
            .assertQD[Double, Meter](1.9144)
        (1d.withUnit[Meter] + 1f.withUnit[Meter].toValue[Double])
            .assertQD[Double, Meter](2)
    }
    ...
    test("addition standard") {
        ...
        (1d.withUnit[Kilogram] + 1f.withUnit[Pound])
            .assertQD[Double, Kilogram](1.45359237)
        (1d.withUnit[Kilogram] + 1L.withUnit[Pound])
            .assertQD[Double, Kilogram](1.45359237)
        (1d.withUnit[Kilogram] + 1.withUnit[Pound])
            .assertQD[Double, Kilogram](1.45359237)

        (1f.withUnit[Kilogram] + 1d.withUnit[Pound])
            .assertQD[Double, Kilogram](1.45359237)
        (1L.withUnit[Kilogram] + 1d.withUnit[Pound])
            .assertQD[Double, Kilogram](1.45359237)
        (1.withUnit[Kilogram] + 1d.withUnit[Pound])
            .assertQD[Double, Kilogram](1.45359237)

        (1f.withUnit[Kilogram] + 1f.withUnit[Pound])
            .assertQD[Float, Kilogram](1.45359237)
        (1f.withUnit[Kilogram] + 1L.withUnit[Pound])
            .assertQD[Float, Kilogram](1.45359237)
        (1f.withUnit[Kilogram] + 1.withUnit[Pound])
            .assertQD[Float, Kilogram](1.45359237)

        (1f.withUnit[Kilogram] + 1f.withUnit[Pound])
            .assertQD[Float, Kilogram](1.45359237)
        (1L.withUnit[Kilogram] + 1f.withUnit[Pound])
            .assertQD[Float, Kilogram](1.45359237)
        (1.withUnit[Kilogram] + 1f.withUnit[Pound])
            .assertQD[Float, Kilogram](1.45359237)
        ...
        // truncating
        (1L.withUnit[Second] + 1L.withUnit[Minute].tToUnit[Second])
            .assertQ[Long, Second](61)
        (1L.withUnit[Second] + 1.withUnit[Minute].tToUnit[Second])
            .assertQ[Long, Second](61)
        (1.withUnit[Second] + 1L.withUnit[Minute].tToUnit[Second])
            .assertQ[Long, Second](61)
        (1.withUnit[Second] + 1.withUnit[Minute].tToUnit[Second])
            .assertQ[Int, Second](61)

        // integer truncation can cause loss of precision
        (1L.withUnit[Meter] + 1L.withUnit[Yard].tToUnit[Meter])
            .assertQ[Long, Meter](1)
        (1L.withUnit[Meter] + 1.withUnit[Yard].tToUnit[Meter])
            .assertQ[Long, Meter](1)
        (1.withUnit[Meter] + 1L.withUnit[Yard].tToUnit[Meter])
            .assertQ[Long, Meter](1)
        (1.withUnit[Meter] + 1.withUnit[Yard].tToUnit[Meter])
            .assertQ[Int, Meter](1)

        // fp effects (e.g. (3 * 0.3333).toInt -> 0) are avoided when possible
        (1.withUnit[Yard] + 3.withUnit[Foot].tToUnit[Yard])
            .assertQ[Int, Yard](2)
        (1L.withUnit[Yard] + 3L.withUnit[Foot].tToUnit[Yard])
            .assertQ[Long, Yard](2)
    }
    ...
    test("subtraction strict") {
        ...
        // explicit conversion will still work
        (1d.withUnit[Meter] - 1d.withUnit[Yard].toUnit[Meter])
            .assertQD[Double, Meter](0.0856)
        (3d.withUnit[Meter] - 1f.withUnit[Meter].toValue[Double])
            .assertQD[Double, Meter](2)
    }
    ...
    test("subtraction standard") {
        ...
        // differing value and unit
        (1d.withUnit[Kilogram] - 1f.withUnit[Pound])
            .assertQD[Double, Kilogram](0.54640763)
        (1d.withUnit[Kilogram] - 1L.withUnit[Pound])
            .assertQD[Double, Kilogram](0.54640763)
        (1d.withUnit[Kilogram] - 1.withUnit[Pound])
            .assertQD[Double, Kilogram](0.54640763)
        ...
        (1f.withUnit[Kilogram] - 1f.withUnit[Pound])
            .assertQD[Float, Kilogram](0.54640763)
        (1f.withUnit[Kilogram] - 1L.withUnit[Pound])
            .assertQD[Float, Kilogram](0.54640763)
        (1f.withUnit[Kilogram] - 1.withUnit[Pound])
            .assertQD[Float, Kilogram](0.54640763)
        ...
        // truncating
        (61L.withUnit[Second] - 1L.withUnit[Minute].tToUnit[Second])
            .assertQ[Long, Second](1)
        (61L.withUnit[Second] - 1.withUnit[Minute].tToUnit[Second])
            .assertQ[Long, Second](1)
        (61.withUnit[Second] - 1L.withUnit[Minute].tToUnit[Second])
            .assertQ[Long, Second](1)
        (61.withUnit[Second] - 1.withUnit[Minute].tToUnit[Second])
            .assertQ[Int, Second](1)

        // integer truncation can cause loss of precision
        (2L.withUnit[Meter] - 1L.withUnit[Yard].tToUnit[Meter])
            .assertQ[Long, Meter](2)
        (2L.withUnit[Meter] - 1.withUnit[Yard].tToUnit[Meter])
            .assertQ[Long, Meter](2)
        (2.withUnit[Meter] - 1L.withUnit[Yard].tToUnit[Meter])
            .assertQ[Long, Meter](2)
        (2.withUnit[Meter] - 1.withUnit[Yard].tToUnit[Meter])
            .assertQ[Int, Meter](2)

        // fp effects (e.g. (3 * 0.3333).toInt -> 0) are avoided when possible
        (2.withUnit[Yard] - 3.withUnit[Foot].tToUnit[Yard])
            .assertQ[Int, Yard](1)
        (2L.withUnit[Yard] - 3L.withUnit[Foot].tToUnit[Yard])
            .assertQ[Long, Yard](1)
    }
    ...
    test("multiplication strict") {
        ...
        (2f.withUnit[Meter / Kilogram] * 3f.withUnit[Kilogram / Second])
            .assertQ[Float, Meter / Second](6)
        (2L.withUnit[Meter / Second] * 3L.withUnit[1 / Second])
            .assertQ[Long, Meter / (Second ^ 2)](6)
    ...
    test("multiplication standard") {
        ...
        (3f.withUnit[Meter / Second] * 5d.withUnit[Second / Meter])
            .assertQ[Double, 1](15)
        (3f.withUnit[Meter / Second] * 5f.withUnit[Second / Meter])
            .assertQ[Float, 1](15)
        (3f.withUnit[Meter / Second] * 5L.withUnit[Second / Meter])
            .assertQ[Float, 1](15)
        (3f.withUnit[Meter / Second] * 5.withUnit[Second / Meter])
            .assertQ[Float, 1](15)

        (3L.withUnit[1 / Second] * 5d.withUnit[Meter / 1])
            .assertQ[Double, Meter / Second](15)
        (3L.withUnit[1 / Second] * 5f.withUnit[Meter / 1])
            .assertQ[Float, Meter / Second](15)
        (3L.withUnit[1 / Second] * 5L.withUnit[Meter / 1])
            .assertQ[Long, Meter / Second](15)
        (3L.withUnit[1 / Second] * 5.withUnit[Meter / 1])
            .assertQ[Long, Meter / Second](15)

        (3.withUnit[Second] * 5d.withUnit[Kilogram])
            .assertQ[Double, Second * Kilogram](15)
        (3.withUnit[Second] * 5f.withUnit[Kilogram])
            .assertQ[Float, Second * Kilogram](15)
        (3.withUnit[Second] * 5L.withUnit[Kilogram])
            .assertQ[Long, Second * Kilogram](15)
    ...
    test("division strict") {
        ...
        // same value types require no implicit conversion
        (12d.withUnit[Meter] / 3d.withUnit[Second])
            .assertQ[Double, Meter / Second](4)
        (12f.withUnit[Meter / Kilogram] / 3f.withUnit[Second / Kilogram])
            .assertQ[Float, Meter / Second](4)
    ...
    test("division standard") {
        ...
        (5d.withUnit[Meter] / 2f.withUnit[Second])
            .assertQ[Double, Meter / Second](2.5)
        (5d.withUnit[Meter] / 2L.withUnit[Second])
            .assertQ[Double, Meter / Second](2.5)
        (5d.withUnit[Meter] / 2.withUnit[Second])
            .assertQ[Double, Meter / Second](2.5)

        (5f.withUnit[Meter] / 2d.withUnit[Second])
            .assertQ[Double, Meter / Second](2.5)
        (5f.withUnit[Meter] / 2f.withUnit[Second])
            .assertQ[Float, Meter / Second](2.5)
        (5f.withUnit[Meter] / 2L.withUnit[Second])
            .assertQ[Float, Meter / Second](2.5)
        (5f.withUnit[Meter] / 2.withUnit[Second])
            .assertQ[Float, Meter / Second](2.5)

        (5L.withUnit[Meter] / 2d.withUnit[Second])
            .assertQ[Double, Meter / Second](2.5)
        (5L.withUnit[Meter] / 2f.withUnit[Second])
            .assertQ[Float, Meter / Second](2.5)
        assertCE("5L.withUnit[Meter] / 2L.withUnit[Second]")
        assertCE("5L.withUnit[Meter] / 2.withUnit[Second]")

        (5.withUnit[Meter] / 2d.withUnit[Second])
            .assertQ[Double, Meter / Second](2.5)
        (5.withUnit[Meter] / 2f.withUnit[Second])
            .assertQ[Float, Meter / Second](2.5)
    ...
    test("truncating division standard") {
        ...
        (5L.withUnit[Meter] `tquot` 2.withUnit[Second])
            .assertQ[Long, Meter / Second](2)

        (5.withUnit[Meter] `tquot` 2L.withUnit[Second])
            .assertQ[Long, Meter / Second](2)
    ...
    test("equality standard") {
        ...
        assertEquals(2L.withUnit[(1 / 2) * Meter] === 2f.withUnit[Meter], false)
        assertEquals(
            2L.withUnit[(1 / 2) * Meter].tToUnit[Meter] === 1L.withUnit[Meter],
            true
        )
        assertEquals(
            2L.withUnit[(1 / 2) * Meter].tToUnit[Meter] === 2.withUnit[Meter],
            false
        )
        ...
        assertEquals(2.withUnit[(1 / 2) * Meter] === 1f.withUnit[Meter], true)
        assertEquals(
            1.withUnit[(1 / 2) * Meter].tToUnit[Meter] === 1L.withUnit[Meter],
            false
        )
        assertEquals(
            2.withUnit[(1 / 2) * Meter].tToUnit[Meter] === 1.withUnit[Meter],
            true
        )
    }
